...
<body>
	...
	<div class="container">
		...
		<form method="POST" action="<%= Constants.Pages.UPDATE_TODO %>">
			<fieldset>
				<input type="hidden" name="todoId" value="${todo.id}"/>
				<label>Edit Todo:</label>
				<input name="todo" type="text" class="form-control" value="${todo.name}" required/> <br/>
			</fieldset>
			<fieldset>
				<label>Category:</label>
				<input name="category" type="text" class="form-control" value="${todo.category}" required/> <br/>
			</fieldset>
			<fieldset>
